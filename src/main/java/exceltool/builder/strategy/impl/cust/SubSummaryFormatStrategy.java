...
public class SubSummaryFormatStrategy implements CellFormatStrategy {
    private static final String FORMAT_CODE = "subSummary";
    private static final String ROW_BG_COLOR = "#FEFAEB";
    private static final String CELL_BG_COLOR = "#FCEDBD";
